...
# Сколько ядер отдавать ОДНОМУ распознаванию нот. Ограничение нужно:
# onnxruntime по умолчанию забирает все ядра, и два одновременных
# задания начинают драться за процессор вместо работы.
#
# Но ограничивать надо именно onnxruntime. Прежняя правка выставляла
# OMP_NUM_THREADS на весь процесс -- и заодно сажала на одно ядро
# PyTorch, то есть Demucs. Разделение и так самый долгий шаг; на
# половине ядер, да ещё с усреднением по сдвигам, оно растянулось на
# часы. Лечение оказалось хуже болезни.
